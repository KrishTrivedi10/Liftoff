...
class Upcoming_details extends StatefulWidget {
  final int index1;
  Upcoming_details({required this.index1});
  @override
  _Upcoming_detailsState createState() => _Upcoming_detailsState();
}

class _Upcoming_detailsState extends State<Upcoming_details> {
  ...
  void initState() {
    super.initState();
    fetchUpcoming_details(widget.index1);
